...
public class signup3 extends JFrame implements ActionListener  {
    ...
    JLabel l1,card,type,number,pin,pinnumber,carddetail,pindetail,service;
    ...
    signup3(String formno){
        ...
        number=new JLabel("XXXX-XXXX-XXXX-8474");
        number.setBounds(330,300,300,30);
        number.setFont(new Font("Raleway",Font.BOLD,22));
        add(number);
        carddetail=new JLabel("Your 16 Digit Card Detail");
        ...
        add(c6);
        c7=new JCheckBox("I hereby declares that the above entered details are correct to best of my Knowledge");
        c7.setBackground(Color.WHITE);
        c7.setFont(new Font("Raleway",Font.BOLD,12));
        c7.setBounds(100,670,520,30);
        add(c7);
